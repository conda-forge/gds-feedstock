...
Once the `conda-forge` channel has been enabled, `gds-base, gds-base-crtools, gds-base-frameio, gds-base-gdstrig, gds-base-monitors, gds-base-runtime, gds-base-web, gds-framexmit, gds-services` can be installed with:

```
conda install gds-base gds-base-crtools gds-base-frameio gds-base-gdstrig gds-base-monitors gds-base-runtime gds-base-web gds-framexmit gds-services
```
